  ...
  - platform: becker
    ...
    covers:
      ...
      livingroom:
        ...
        channel: "2:1"
        # Optional Travel Time to track cover position by time (needed for percentage Integration in HA)
        travelling_time_up: 30
        # Optional Travel Time for direction down (needed for percentage Integration in HA)
...
To use your cover in HA you need to pair it first with the USB stick. To pair your cover run the service becker.pair. See HA Settings > Developer Tools > Actions

```yaml
action: becker.pair
data:
  # You can choose same Channel from your remote control device
  channel: 1
  # stick use default unit 1; dont have to change it
  unit: 1
```

Follow the paring construction of your cover
...
`DEBUG ... \[pybecker.becker_helper\] Received packet: **unit_id: 12345, channel: 2**, command: HALT, argument: 0, packet: b'\x020000000002010B0000000000123450210001001000\x03'`

## Support

[![Donate](https://img.shields.io/badge/Donate-PayPal-green.svg)](https://paypal.me/paddy2101)
